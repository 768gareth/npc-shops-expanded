...
public class StylistPatch 
{
  ...
  static void onExit(@This StylistHumanMob Mob) 
  {
      ...
      Mob.shop.addSellingItem("crimsonhat", new SellingShopItem()).setStaticPriceBasedOnHappiness(75, 150, 20);
      Mob.shop.addSellingItem("crimsonrobe", new SellingShopItem()).setStaticPriceBasedOnHappiness(75, 150, 20);
      Mob.shop.addSellingItem("crimsonshoes", new SellingShopItem()).setStaticPriceBasedOnHappiness(75, 150, 20);
      ...
      Mob.shop.addSellingItem("hunterhoodmask", new SellingShopItem()).setStaticPriceBasedOnHappiness(75, 150, 20);
      ...
      Mob.shop.addSellingItem("captainshat", new SellingShopItem()).setStaticPriceBasedOnHappiness(350, 700, 50);
      Mob.shop.addSellingItem("captainsshirt", new SellingShopItem()).setStaticPriceBasedOnHappiness(350, 700, 50);
      Mob.shop.addSellingItem("captainsboots", new SellingShopItem()).setStaticPriceBasedOnHappiness(350, 700, 50);
      Mob.shop.addSellingItem("pirateeyepatch", new SellingShopItem()).setStaticPriceBasedOnHappiness(250, 450, 40);
      Mob.shop.addSellingItem("piratebandana", new SellingShopItem()).setStaticPriceBasedOnHappiness(250, 450, 40);
      Mob.shop.addSellingItem("piratebandanawitheyepatch", new SellingShopItem()).setStaticPriceBasedOnHappiness(250, 450, 40);
      Mob.shop.addSellingItem("pirateshirt", new SellingShopItem()).setStaticPriceBasedOnHappiness(250, 450, 40);
      Mob.shop.addSellingItem("pirateboots", new SellingShopItem()).setStaticPriceBasedOnHappiness(250, 450, 40);
