...
public class ExoticMerchantPatch 
{
  ...
  static void onExit(@This ExoticMerchantHumanMob Mob) 
  {
      ...
      Mob.shop.addSellingItem("foolsgambit", new SellingShopItem()).setRandomPrice(1200, 1600).addKilledMobRequirement("piratecaptain");
      ...
      (
        ...
        "deepfriedchicken", "parisiansteak"
      );
      ...
      Mob.shop.addSellingItem("musicplayer", new SellingShopItem()).setRandomPrice(800, 1200);
      Mob.shop.addSellingItem("portablemusicplayer", new SellingShopItem()).setRandomPrice(800, 1200);
