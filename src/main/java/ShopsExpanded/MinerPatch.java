...
public class MinerPatch 
{
  ...
  static void onExit(@This MinerHumanMob Mob) 
  {
      ...
      Mob.shop.addSellingItem("ironbomb", new SellingShopItem()).setStaticPriceBasedOnHappiness(25, 40, 5);
      Mob.shop.addSellingItem("dynamitestick", new SellingShopItem()).setStaticPriceBasedOnHappiness(40, 80, 5);
